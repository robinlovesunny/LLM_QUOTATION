...
BEGIN
    ...
    INSERT INTO pricing_model (
        ...
        NULL, '0<Token≤32K', NULL,
        FALSE, TRUE,
        NULL, 'Token范围:0<Token≤32K | 上下文缓存折扣'
    ) RETURNING id INTO v_model_id;
    INSERT INTO pricing_model_price (
        snapshot_id, model_id, dimension_code, unit_price, unit, mode, token_tier, resolution, rule_text
    ) VALUES (
    ...
    INSERT INTO pricing_model (
        ...
        v_snapshot_id, v_category_id, 'qwen3-coder-plus', 'qwen3-coder-plus', 
        '通义千问Coder - qwen3-coder-plus', '通义千问Coder',
        NULL, '32K<Token≤128K', NULL,
        FALSE, TRUE,
        NULL, 'Token范围:32K<Token≤128K | 上下文缓存折扣'
    ) RETURNING id INTO v_model_id;
    INSERT INTO pricing_model_price (
        snapshot_id, model_id, dimension_code, unit_price, unit, mode, token_tier, resolution, rule_text
    ) VALUES (
        v_snapshot_id, v_model_id, 'input_token', 0.006, 
        '元', NULL, '32K<Token≤128K', 
        NULL, 'Token范围:32K<Token≤128K | 上下文缓存折扣'
    );
    INSERT INTO pricing_model_price (
        snapshot_id, model_id, dimension_code, unit_price, unit, mode, token_tier, resolution, rule_text
    ...
    INSERT INTO pricing_model (
        ...
        v_snapshot_id, v_category_id, 'qwen3-coder-plus', 'qwen3-coder-plus', 
        '通义千问Coder - qwen3-coder-plus', '通义千问Coder',
        NULL, '128K<Token≤256K', NULL,
        FALSE, TRUE,
        NULL, 'Token范围:128K<Token≤256K | 上下文缓存折扣'
    ) RETURNING id INTO v_model_id;
    INSERT INTO pricing_model_price (
        snapshot_id, model_id, dimension_code, unit_price, unit, mode, token_tier, resolution, rule_text
    ) VALUES (
        v_snapshot_id, v_model_id, 'input_token', 0.01, 
        '元', NULL, '128K<Token≤256K', 
        NULL, 'Token范围:128K<Token≤256K | 上下文缓存折扣'
    );
    INSERT INTO pricing_model_price (
        snapshot_id, model_id, dimension_code, unit_price, unit, mode, token_tier, resolution, rule_text
    ...
    INSERT INTO pricing_model (
        ...
        v_snapshot_id, v_category_id, 'qwen3-coder-plus', 'qwen3-coder-plus', 
        '通义千问Coder - qwen3-coder-plus', '通义千问Coder',
        NULL, '256K<Token≤1M', NULL,
        FALSE, TRUE,
        NULL, 'Token范围:256K<Token≤1M | 上下文缓存折扣'
    ) RETURNING id INTO v_model_id;
    INSERT INTO pricing_model_price (
        snapshot_id, model_id, dimension_code, unit_price, unit, mode, token_tier, resolution, rule_text
    ) VALUES (
        v_snapshot_id, v_model_id, 'input_token', 0.02, 
        '元', NULL, '256K<Token≤1M', 
        NULL, 'Token范围:256K<Token≤1M | 上下文缓存折扣'
    );
    INSERT INTO pricing_model_price (
        snapshot_id, model_id, dimension_code, unit_price, unit, mode, token_tier, resolution, rule_text
    ...
    INSERT INTO pricing_model (
        ...
        v_snapshot_id, v_category_id, 'qwen3-coder-480b-a35b-instruct', 'qwen3-coder-480b-a35b-instruct', 
        'Qwen-Coder - qwen3-coder-480b-a35b-instruct', 'Qwen-Coder',
        NULL, '128K<Token≤200K', NULL,
        FALSE, FALSE,
        NULL, 'Token范围:128K<Token≤200K'
    ) RETURNING id INTO v_model_id;
    INSERT INTO pricing_model_price (
        snapshot_id, model_id, dimension_code, unit_price, unit, mode, token_tier, resolution, rule_text
    ) VALUES (
        v_snapshot_id, v_model_id, 'input_token', 0.015, 
        '元', NULL, '128K<Token≤200K', 
        NULL, 'Token范围:128K<Token≤200K'
    );
    INSERT INTO pricing_model_price (
        snapshot_id, model_id, dimension_code, unit_price, unit, mode, token_tier, resolution, rule_text
    ...
    INSERT INTO pricing_model_price (
        ...
        v_snapshot_id, v_model_id, 'video_second', 0.004, 
        '张', NULL, NULL, 
        NULL, NULL
    );
    ...
    INSERT INTO pricing_model_price (
        ...
        v_snapshot_id, v_model_id, 'output_price', 0.0018, 
        '元', NULL, NULL, 
        NULL, NULL
    );
    ...
    INSERT INTO pricing_model_price (
        ...
        v_snapshot_id, v_model_id, 'output_price', 0.0009, 
        '元', NULL, NULL, 
        NULL, NULL
    );
